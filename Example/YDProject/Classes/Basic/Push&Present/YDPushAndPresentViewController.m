...
{
    {
        ...
        btn.frame = CGRectMake(10, 100, kScreenWidth - 20, 40);
    ...
    
    {
        ...
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        btn.frame = CGRectMake(10, 200, kScreenWidth - 20, 40);
        btn.backgroundColor = [UIColor randomColor];
    ...
    
    {
        ...
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        btn.frame = CGRectMake(10, 300, kScreenWidth - 20, 40);
        btn.backgroundColor = [UIColor randomColor];
    ...
    
    {
        ...
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        btn.frame = CGRectMake(10, 400, kScreenWidth - 20, 40);
        btn.backgroundColor = [UIColor randomColor];
    ...
    
    {
        ...
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        btn.frame = CGRectMake(10, 500, kScreenWidth - 20, 40);
        btn.backgroundColor = [UIColor randomColor];
    ...
    
    {
        ...
        [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        btn.frame = CGRectMake(10, 600, kScreenWidth - 20, 40);
        btn.backgroundColor = [UIColor randomColor];
