//
//  PresentationAnimatedTransition.m
//  JMPanKeTong
//
...
@interface PresentationAnimatedTransition ()
...
@implementation PresentationAnimatedTransition
...
{
    return _transitionStyle == TransitionStylePresentation ? 0.5 : 0.25;
}
...
//
//    UIView *toView, *fromView, *transitionView;
//
...
//    }
//
//    BOOL isPresent = self.transitionStyle == TransitionStylePresentation;
//    if (isPresent) {
//        transitionView = toView;
...
//
//    transitionView.frame = CGRectMake(0, isPresent ? height :0, width, height);
//
//    [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
//        transitionView.frame = CGRectMake(0, isPresent ? 0 :height, width, height);
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    toVC.view.frame = CGRectMake(0, containerView.bounds.size.height, containerView.bounds.size.width, 700);
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0 usingSpringWithDamping:0.55 initialSpringVelocity:1.0 / 0.55 options:0 animations:^{
        //首先我们让vc2向上移动
        toVC.view.transform = CGAffineTransformMakeTranslation(0, -700);
        //然后让截图视图缩小一点即可
